...
class Transport extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    async setMaxOutgoingBitrate(bitrate) {
        ...
        const reqData = { bitrate };
        await this._channel.request('transport.setMaxOutgoingBitrate', this._internal, reqData);
    }
    /**
     * Create a Producer.
     */
    async produce({ id = undefined, kind, rtpParameters, paused = false, keyFrameRequestDelay, appData = {} }) {
        ...
        if (this.constructor.name !== 'PipeTransport') {
            ...
            // do not include CNAME, create a random one.
                ...
                this._cnameForProducers = (0, uuid_1.v4)().substr(0, 8);
            }
        ...
        const internal = { ...this._internal, producerId: id || (0, uuid_1.v4)() };
    ...
    async consume({ producerId, rtpCapabilities, paused = false, mid, preferredLayers, pipe = false, appData = {} }) {
        ...
        const internal = { ...this._internal, consumerId: (0, uuid_1.v4)(), producerId };
        const reqData = {
            kind: producer.kind,
            rtpParameters,
    ...
    async produceData({ id = undefined, sctpStreamParameters, label = '', protocol = '', appData = {} } = {}) {
        ...
        const internal = { ...this._internal, dataProducerId: id || (0, uuid_1.v4)() };
        const reqData = {
            type,
    ...
    async consumeData({ dataProducerId, ordered, maxPacketLifeTime, maxRetransmits, appData = {} }) {
        ...
        const internal = { ...this._internal, dataConsumerId: (0, uuid_1.v4)(), dataProducerId };
        const reqData = {
            type,
            sctpStreamParameters,
            label,
