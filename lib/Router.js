...
const AudioPCMObserver_1 = require("./AudioPCMObserver");
...
class Router extends EnhancedEventEmitter_1.EnhancedEventEmitter {
    ...
    async createWebRtcTransportForOtherUdp({ enableOtherUdp = true, otherUdpIp, otherUdpPort, initialAvailableOutgoingBitrate = 600000, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, sctpSendBufferSize = 262144, appData = {} }) {
        logger.debug('createWebRtcTransport()');
        if (appData && typeof appData !== 'object')
            throw new TypeError('if given, appData must be an object');
        const internal = { ...this._internal, transportId: (0, uuid_1.v4)() };
        const reqData = {
            enableOtherUdp,
            otherUdpIp,
            otherUdpPort,
     ...
     */
    async createWebRtcTransport({ enableOtherUdp = false, listenIps, port, enableUdp = true, enableTcp = false, preferUdp = false, preferTcp = false, initialAvailableOutgoingBitrate = 600000, enableSctp = false, numSctpStreams = { OS: 1024, MIS: 1024 }, maxSctpMessageSize = 262144, sctpSendBufferSize = 262144, appData = {} }) {
        logger.debug('createWebRtcTransport()');
    ...
    async createActiveSpeakerObserver({ interval = 300, appData = {} } = {}) {
        ...
        if (appData && typeof appData !== 'object')
            throw new TypeError('if given, appData must be an object');
        const internal = { ...this._internal, rtpObserverId: (0, uuid_1.v4)() };
     ...
     */
    async createAudioPCMObserver({ maxEntries = 1, threshold = -80, interval = 1000, appData = {} } = {}) {
        ...
        const audioPCMObserver = new AudioPCMObserver_1.AudioPCMObserver({
            internal,
            channel: this._channel,
            payloadChannel: this._payloadChannel,
            appData,
