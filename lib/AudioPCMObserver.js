...
exports.AudioPCMObserver = void 0;
const Logger_1 = require("./Logger");
const RtpObserver_1 = require("./RtpObserver");
const logger = new Logger_1.Logger('AudioPCMObserver');
class AudioPCMObserver extends RtpObserver_1.RtpObserver {
    /**
     * @private
...
exports.AudioPCMObserver = AudioPCMObserver;
